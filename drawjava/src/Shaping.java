...
public class Shaping extends JComponent {
    Image image;
...
//                System.out.println("lokasi mouse : (" + e.getX() + "," + e.getY() + ")");
//                drawing.lokasi.setText("(" + e.getX()+","+e.getY()+")");
                    ...
                    case "5f":
                        switch (lineType) {
                            ...
                            case "Dot":
                                ...
                                break;
                            case "DashDot":
                                pattern = new float[]{10f, 9f, 1f, 9f};
                                break;
                        }
                    ...
                    case "7f":
                        switch (lineType) {
                            ...
                            case "Dot":
                                ...
                                break;
                            case "DashDot":
                                pattern = new float[]{12f, 11f, 1f, 11f};
                                break;
                        }
...
//                        box = new Rectangle(minX, minY, maxX - minX, maxY - minY);
    ...
    public void doTrapezoid(){
        ...
        int titikKiriAtasX = minX+minX/10;
        int titikKananAtasX = maxX-maxX/10;

                        //kiri bawah, kiri atas, kanan atas, kanan bawah
        int xPoints[] = new int[]{titikKiriAtasX, minX,  maxX, titikKananAtasX};
        int yPoints[] = new int[]{minY,  maxY, maxY, minY};
